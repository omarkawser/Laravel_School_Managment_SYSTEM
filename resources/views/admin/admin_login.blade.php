...
<body class="sidebar-dark">
  ...
  <!-- container-scroller -->
  <!-- plugins:js -->
  <script src="{{asset('node_modules/jquery/dist/jquery.min.css')}} ">  </script>
  <script src="{{asset('node_modules/popper.js/dist/umd/popper.min.css')}} ">  </script>
  <script src="{{asset('node_modules/bootstrap/dist/js/bootstrap.min.css')}} "> </script>
  <script src="{{asset('node_modules/perfect-scrollbar/dist/js/perfect-scrollbar.jquery.min.css')}} "> </script>
  <!-- endinject -->
  <!-- inject:js -->
